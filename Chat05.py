...
# Juntando o texto de todas as URLs
texto_completo = ""
for url in urls:
    noticia = g.extract(url)
    texto_completo += noticia.cleaned_text + " "  # Adiciona um espaço entre os textos

nlp = spacy.load("pt_core_news_sm")
texto = [sent.text for sent in nlp(texto_completo).sents]
